...
项目地址：[https://github.com/ElderJames/ant-design-blazor](https://github.com/ElderJames/ant-design-blazor) 求 Star。
...
![](/images/blazor_serverless/blazor.png)
...
![](/images/blazor_serverless/publish.png)
...
- [Node.js](https://nodejs.org/dist/v12.16.1/node-v12.16.1-x64.msi) (Node.js 版本需不低于 8.6，建议使用最新版本)
...
![](/images/blazor_serverless/yml.png)
...
![](/images/blazor_serverless/deploy.png)
